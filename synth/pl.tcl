...
read_file -f ddc [list ${rs_module}.ddc ${mt_module}.ddc ${arch_mt_module}.ddc ${is_fifo_module}.ddc ${freelist_module}.ddc ${rob_module}.ddc ${pr_module}.ddc ${alu_module}.ddc ${branch_module}.ddc]
set_dont_touch [list ${rs_module} ${mt_module} ${arch_mt_module} ${is_fifo_module} ${freelist_module} ${rob_module} ${pr_module} ${alu_module} ${branch_module}]
