...
$(PLSYNFILES):	$(PLFILES) $(RSSYNFILES) $(MTSYNFILES) $(ARCHMTSYNFILES) $(ISFIFOSYN) $(FREELISTSYNFILES) $(ROBSYNFILES) $(PRSYNFILES) $(MULTSYNFILES) $(SQSYNFILES) $(LOADSYNFILES) $(ICACHESYNFILES) $(DCSYNFILES) $(SYNTH_DIR)/pl.tcl 
